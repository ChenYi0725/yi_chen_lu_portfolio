...
TextStyle contactTextStyle = TextStyle(color: Colors.white, fontSize: 1020);
TextStyle photoDetailTitleStyle = TextStyle(color: Colors.white, fontSize: 48);
TextStyle photoDetailContentStyle = TextStyle(
  color: Colors.white,
  fontSize: 28,
);
